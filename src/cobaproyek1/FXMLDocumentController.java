...
public class FXMLDocumentController implements Initializable {
    ...
    void Klikkedua(ActionEvent event) {
        ...
        paket = "Setrika";
        else if (sehari.isSelected())
        paket = "Paket Kilat";
        else
        paket = "";
        
        if(!(rdCK.isSelected() || rdCKS.isSelected() || rdS.isSelected() || sehari.isSelected())){
